          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <span className="text-secondary-700">認定マインドエンジニアリングコーチ</span>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 w-2 h-2 bg-primary rounded-full mt-3 mr-3"></div>
                  <span className="text-secondary-700">認知科学応用コーチング研修修了</span>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 w-2 h-2 bg-primary rounded-full mt-3 mr-3"></div>
                  <span className="text-secondary-700">国際コーチ連盟（ICF）認定コーチ</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  <div className="flex-shrink-0 w-2 h-2 bg-primary rounded-full mt-3 mr-3"></div>
                  <span className="text-secondary-700">エグゼクティブコーチング</span>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 w-2 h-2 bg-primary rounded-full mt-3 mr-3"></div>
                  <span className="text-secondary-700">キャリア・トランジション支援</span>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 w-2 h-2 bg-primary rounded-full mt-3 mr-3"></div>
                  <span className="text-secondary-700">パフォーマンス向上コーチング</span>
                </li>
              </ul>
            </div>
          </div>
